...
python${python_version_for_venv} -m venv --clear --copies "${project_root_dir_abs}/${venv_name}/env/icarus_runtime"

# Activate local venv
source "${project_root_dir_abs}/${venv_name}/env/icarus_runtime/bin/activate"
